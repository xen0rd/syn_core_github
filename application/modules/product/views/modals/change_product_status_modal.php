...
<div class="modal-body">
	<p>Are you sure you want to change this product's status?</p>
</div>
...
<script>
	$("#confirm_status_change").click(function(){
		$.ajax({
			url:"<?=site_url('product/changeProductStatus');?>",
			type: "POST",
			...
			success: function(data){
				if(data === "TRUE"){
					$('#toggle_product_' + <?=$this->uri->segment(3); ?>).bootstrapToggle("toggle");
